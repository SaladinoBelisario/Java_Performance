...
- [**Introduction**](#introduction)
    - [**Definitions**](#definitions)
        - [Java Performance Overview](#java-performance-overview)
        - [Definitions](#definitions)
    - [**Overview of the JVM**](#overview-of-the-jvm)
        ...
        - [Monitoring and Tooling for the JVM](#monitoring-and-tooling-for-the-jvm)
        - [Meet the JVMs](#meet-the-jvms)
- [**Performance Testing**](#performance-testing)
    ...
    - [**Types of performance testing**](#types-of-performance-testing)
        ...
        - [Capacity planning test](#capacity-planning-test)
        - [Degradation test](#degradation-test)
    - [**Best practices**](#best-practices)
        - [Top-Down Reference](#top-down-reference)
        ...
        - [Performance testing as part of the SDLC](#performance-testing-as-part-of-the-sdlc)
    ...
    - [**Performance antipatterns**](#performance-antipatterns)
        - [Introduction to antipatterns](#introduction-to-antipatterns)
            - [Boredom](#boredom)
            - [Résumé padding](#rsum-padding)
            - [Peer pressure](#peer-pressure)
            - [Lack of understanding](#lack-of-understanding)
            - [Misunderstood/Nonexistent problem](#misunderstoodnonexistent-problem)
        - [Antipatterns catalogue](#antipatterns-catalogue)
            - [Distracted by shiny](#distracted-by-shiny)
            - [Distracted by simple](#distracted-by-simple)
            - [Performance tuning wizard](#performance-tuning-wizard)
            - [Tuning by folklore](#tuning-by-folklore)
            - [The blame donkey](#the-blame-donkey)
            - [Missing the bigger picture](#missing-the-bigger-picture)
            - [UAT is my desktop](#uat-is-my-desktop)
            - [Production-like data is hard](#production-like-data-is-hard)
    - [**Cognitive biases**](#cognitive-biases)
        - [Reductionist thinking](#reductionist-thinking)
        - [Confirmation bias](#confirmation-bias)
        - [Fog of war](#fog-of-war)
        - [Risk bias](#risk-bias)
        - [Ellsberg's paradox](#ellsbergs-paradox)
- [**A Java Performance Toolbox**](#a-java-performance-toolbox)
    ...
    - [**GC Logging**](#gc-logging)
        - [Switching On GC Logging](#switching-on-gc-logging)
        - [GC Logs Versus JMX](#gc-logs-versus-jmx)
    - [**Profiling Tools**](#profiling-tools)
        - [Modern profilers](#modern-profilers)
...
- [**JVM and Compilers**](#jvm-and-compilers)
    - [**Just-in-Time Compilers: An Overview**](#just-in-time-compilers-an-overview)
        - [Introducing JITWatch](#introducing-jitwatch)
        - [Inlining](#inlining)
        - [Loop unrolling](#loop-unrolling)
        - [Escape analysis](#escape-analysis)
        - [Monomorphic Dispatch](#monomorphic-dispatch)
        - [Intrinsics](#intrinsics)
        - [On-Stack Replacement](#on-stack-replacement)
        - [Safepoints Revisited](#safepoints-revisited)
...
- [**Java SE API Tips**](#java-se-api-tips)
    ...
    - [**Java Collections API**](#java-collections-api)
        - [Optimizing collections](#optimizing-collections)
            - [Optimizing collections for Lists](#optimizing-collections-for-lists)
            - [Optimizing collections for Maps](#optimizing-collections-for-maps)
            - [Optimizing collections for Sets](#optimizing-collections-for-sets)
    ...
    - [**Avoid finalization**](#avoid-finalization)
